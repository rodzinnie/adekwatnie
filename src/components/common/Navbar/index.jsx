  ...
  return (
    <div className={styles.root} ref={rootRef}>
            ...
            <nav ref={inputRef} className={styles.nav}>
               <a className={styles.navlink} href="#offer">oferta</a>
               <a className={styles.navlink} href="#about">o mnie</a>
               <a className={styles.navlink} href="#contact">kontakt</a>
            </nav>
            <div className={styles.hamburger}>
                <Hamburger onToggle={handleHamburger} toggled={isOpen} toggle={setOpen} color="#000000"/>
            </div>
    </div>
  )
}
